...
print(
    "The goal is to reach the hand value of 21 without passing it. Ace counts for either 1 or 11."
)
...
while game_on:
    ...
    # Ask for balance to create a player account
